...
<Tip>
  ...
  guide](https://codeqr.mintlify.app/conversions/sales/shopify) for more information.
</Tip>
...
- [`POST /track/lead`](https://codeqr.mintlify.app/api-reference/endpoint/track-lead)
- [`POST /track/sale`](https://codeqr.mintlify.app/api-reference/endpoint/track-sale)
...
<CardGroup cols={2}>
  <Card
    ...
    icon="book-open"
    href="https://codeqr.mintlify.app/conversions/leads/introduction"
  >
  ...
  <Card
    ...
    icon="code"
    href="https://codeqr.mintlify.app/api-reference/endpoint/track-lead"
  >
...
<CardGroup cols={2}>
  <Card
    title="Stripe"
    icon="stripe"
    href="https://codeqr.mintlify.app/conversions/sales/stripe"
    horizontal
  />
  <Card
    title="Shopify"
    icon="shopify"
    href="https://codeqr.mintlify.app/conversions/sales/shopify"
    horizontal
  />
</CardGroup>

Alternatively, you can also send sale events manually using [our SDKs](/sdks/overview) or the [`POST /track/sale` API endpoint](https://codeqr.mintlify.app/api-reference/endpoint/track-sale).
...
<CardGroup cols={2}>
  <Card
    ...
    icon="book-open"
    href="https://codeqr.mintlify.app/conversions/sales/introduction"
  >
  ...
  <Card
    ...
    icon="code"
    href="https://codeqr.mintlify.app/api-reference/endpoint/track-sale"
  >
