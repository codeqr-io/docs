...
<CardGroup>
  <Card
    title="React"
    icon="react"
    href="https://docs.codeqr.io/sdks/client-side/installation-guides/react"
  >
  ...
  <Card
    ...
    icon="browser"
    href="https://docs.codeqr.io/sdks/client-side/installation-guides/manual"
  >
  ...
  <Card
    title="Shopify"
    icon="shopify"
    href="https://docs.codeqr.io/sdks/client-side/installation-guides/shopify"
  >
  ...
  <Card
    title="WordPress"
    icon="wordpress"
    href="https://docs.codeqr.io/sdks/client-side/installation-guides/wordpress"
  >
  ...
  <Card
    title="Webflow"
    icon="webflow"
    href="https://docs.codeqr.io/sdks/client-side/installation-guides/webflow"
  >
