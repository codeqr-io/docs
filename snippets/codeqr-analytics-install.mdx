<Steps titleSize="h3">
  ...
  <Step title="Optional: Set up client-side click tracking">
    ...
    If you're using referral links for affiliate management, you will also need to set up the `domainsConfig.refer` property to enable [client-side click-tracking](/sdks/client-side/features/client-side-click-tracking).
