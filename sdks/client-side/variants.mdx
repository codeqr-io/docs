...
description: Learn more about the different variants of the @codeqr/analytics script.
---
...
The base script is available on [`script.js`](https://cdn.codeqr.io/analytics/script.js), and all variants are available on `script.[variant].js`.

For instance, the `outbound-domains` variant is available on [`script.outbound-domains.js`](https://cdn.codeqr.io/analytics/script.outbound-domains.js).

You can also mix and match variants. For example, you can use the `site-visit` and `outbound-domains` variants together with this script: [`script.site-visit.outbound-domains.js`](https://cdn.codeqr.io/analytics/script.site-visit.outbound-domains.js).
...
```html Other
<script
  src="https://cdn.codeqr.io/analytics/script.site-visit.js"
...
```html Other
<script
  src="https://cdn.codeqr.io/analytics/script.outbound-domains.js"
...
```html Other
<script
  src="https://cdn.codeqr.io/analytics/script.site-visit.outbound-domains.js"
