...
The script handles the detection of the `codeqr_id` query parameter and storing it as a first-party cookie, which will be used to attribute subsequent conversion events to the original link.

<Frame>
  <img
    className="rounded-lg border border-gray-100"
    src="https://assets.codeqr.link/help/conversion-click-event.png"
