---
title: "Django"
description: "Learn how to integrate CodeQR with Django."
---
...
To install the [CodeQR Python SDK](https://codeqr.io/sdks/python), run the following command:
...
Let's create a short link using the [CodeQR Python SDK](https://codeqr.io/sdks/python).
...
<CardGroup cols={2}>
  <Card
    ...
    icon="github"
    href="https://github.com/codeqr-io/examples/tree/main/python/django"
    color="#333333"
  >
