---
title: "Stripe"
"og:title": "How to track sale conversions with Stripe and CodeQR"
description: "Learn how to track sale conversion events with Stripe and CodeQR"
---
...
<Frame>
  <img
    ...
    alt="The CodeQR: Conversions Analytics page on the Stripe App Marketplace"
  />
</Frame>
...
<Step title="Connect Stripe to your CodeQR workspace">
...
<Frame>
  <img
    ...
    alt="Connect Stripe to CodeQR"
  />
</Frame>

This will redirect you to the [CodeQR OAuth flow](/integrations/quickstart), where you can select the CodeQR workspace you want to connect to your Stripe account.

<Frame>
  <img
    src="/images/stripe/select-codeqr-workspace.png"
    alt="Select the CodeQR workspace you want to connect to your Stripe account"
  />
</Frame>
...
<Frame>
  <img
    src="https://assets.codeqr.iocms/conversions-payment-links.jpg"
    alt="Stripe payment link with CodeQR click ID"
  />
</Frame>
...
<Note>
  The default currency for all CodeQR workspaces is currently set to `USD`. We will
