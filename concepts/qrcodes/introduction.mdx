...
For more advanced features like [custom QR Code designs](https://codeqr.io/help/article/custom-qr-designs), scan tracking, and more, see the full list of properties [here](/api-reference/endpoint/create-a-qrcode).
