---
title: Introduction
description: "Use webhooks to get real-time notifications on events happening across your CodeQR workspace."
---

Webhooks allows you to listen to real-time events happening across your CodeQR workspace. With webhooks, you can build custom integrations with CodeQR, such as:
...
In this guide, we'll show you how to configure webhooks for your CodeQR workspace and a list of available events you can listen to.

## Creating a webhook

To create a webhook for your CodeQR workspace, you'll need to follow these steps:

Navigate to the [**Webhooks** settings page](https://app.codeqr.io/webhooks) in your CodeQR workspace.
