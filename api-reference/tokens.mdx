  ...
  <Step title="Go to your project">
    ...
    <Frame>
      <img
        ...
        alt="Project API keys on CodeQR"
        width="1468"
        height="249"
      />
    </Frame>
...
| **Restricted**      | This API key will have restricted access to some resources: <ul><li>[Links](/api-reference/endpoint/retrieve-a-list-of-links)</li><li>[Analytics](/api-reference/endpoint/retrieve-analytics)</li><li>[Domains](/api-reference/endpoint/retrieve-a-list-of-domains)</li><li>[Tags](/api-reference/endpoint/retrieve-a-list-of-tags)</li></ul> |
