...
CodeQR's API is capped at **60 requests per minute** per key on the Free plan, with elevated limits on paid plans (see the table below).
...
| [Starter](https://codeqr.io/help/article/starter-plan)   | 100 requests per minute                                                    |
| [Pro](https://codeqr.io/help/article/pro-plan)           | 500 requests per minute                                                    |
| [Business](https://codeqr.io/help/article/business-plan) | 1,000 requests per minute                                                  |
| Scale                                                    | 10,000 requests per minute                                                 |
...
<Frame>
  <img
    src="https://res.cloudinary.com/dhnaggn4g/image/upload/v1753662649/static/webhook-event-logs_dgnqnv.jpg"
