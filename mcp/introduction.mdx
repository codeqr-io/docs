...
description: "Connect CodeQR to Claude, Cursor, Gemini Enterprise, and any other MCP client — no API key to copy around."
---
...
| Domains | read |
| Tags | read and write |
| Your profile | read — name, email and picture |

Access is scoped to the **one project you choose** during sign-in. To reach a second project, connect again and pick that one.

The consent screen lists the same permissions, split into nine lines rather than six — it names read and write separately for links, QR codes and tags.
