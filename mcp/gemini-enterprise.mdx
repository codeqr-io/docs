...
<AccordionGroup>
  ...
  <Accordion title="Verify Auth fails but the URLs look right">
    ...
    It should answer `{"status":"ok","service":"codeqr-mcp-remote","version":"0.1.0"}`. Note that Private Service Connect and VPC Service Controls are not supported by this connector.
  </Accordion>
