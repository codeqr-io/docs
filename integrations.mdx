...
You can build your own integrations with CodeQR's link infrastructure using our [API](/api-reference/introduction).
...
CodeQR also supports webhooks for integrations. You can learn more about them in the [webhooks](/concepts/webhooks/introduction) documentation.
